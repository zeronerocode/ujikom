						...
						<div class="col-md-8 mt-md-4">
							<div class="row">
								<div class="col-md-6">
									...
									<a href="mailto:{{$profile->email}}" class="mb-1 text-muted d-flex align-items-end text-h-primary"><i class="feather icon-mail me-2 f-18"></i>{{$profile->email}}</a>
									<div class="clearfix"></div>
							...
							<div class="card-body border-top pro-det-edit collapse show" id="pro-det-edit-2">
								<form method="POST" action="{{route('update.profile')}}">
									...
									<div class="form-group row align-items-center">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" name="name" placeholder="Full Name" value="{{$profile->name}}">
										</div>
									</div>
									<div class="form-group row align-items-center">
                                    ...
                                    <div class="form-group row align-items-center">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" name="hp" placeholder="Nomor Hp" value="{{$profile->hp}}">
										</div>
									</div>
                                    <div class="form-group row align-items-center">
										<label class="col-sm-3 col-form-label font-weight-bolder">Tempat Lahir</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" name="tempat_lahir" placeholder="Tempat Lahir" value="{{$profile->tempat_lahir}}">
										</div>
									</div>
									<div class="form-group row align-items-center">
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-md-9">
                                            <select class="js-example-basic-single form-control" name="jurusan">
                                                <option value="{{$profile->jurusan}}">Jurusan</option>
